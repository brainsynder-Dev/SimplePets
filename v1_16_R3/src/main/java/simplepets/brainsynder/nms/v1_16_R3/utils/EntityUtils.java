...
public class EntityUtils {
    ...
    public static net.minecraft.server.v1_16_R3.VillagerProfession getProfession(simplepets.brainsynder.wrapper.villager.VillagerType type) {

        net.minecraft.server.v1_16_R3.VillagerProfession profession = VillagerProfession.NONE;
        switch (type) {
            case ARMORER:
