...
public class EntityArmorStandPet extends EntityArmorStand implements IEntityArmorStandPet {
    ...
    private net.minecraft.server.v1_16_R3.ItemStack toNMS (ItemStack stack) {
        return CraftItemStack.asNMSCopy(stack);
    }

    public void setSlot(net.minecraft.server.v1_16_R3.EnumItemSlot enumitemslot, ItemStack itemstack) {
