...
public class EntityArmorStandPet extends ArmorStand implements IEntityArmorStandPet {
    ...
    public void tick() {
        ...
        if ((this.pet == null)
                || (pet.getBukkitEntity().isDead())
                || (!pet.getBukkitEntity().isValid())) {
    ...
    public org.bukkit.entity.ArmorStand getEntity() {
        return (org.bukkit.entity.ArmorStand) this.getBukkitEntity();
    }
    ...
    public boolean attachOwner() {
        ...
        if (owner != null) {
            ...
            return this.getBukkitEntity().addPassenger(owner);
        }
        return false;
    }
    ...
    public void setHeadAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setHeadPose(angle);
    }

    @Override
    public void setBodyAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setBodyPose(angle);
    }

    @Override
    public void setLeftArmAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setLeftArmPose(angle);
    }

    @Override
    public void setRightArmAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setRightArmPose(angle);
    }

    @Override
    public void setLeftLegAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setLeftLegPose(angle);
    }

    @Override
    public void setRightLegAngle(EulerAngle angle) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setRightLegPose(angle);
    }

    @Override
    public EulerAngle getHeadAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getHeadPose();
    }

    @Override
    public EulerAngle getBodyAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getBodyPose();
    }

    @Override
    public EulerAngle getLeftArmAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getLeftArmPose();
    }

    @Override
    public EulerAngle getRightArmAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getRightArmPose();
    }

    @Override
    public EulerAngle getLeftLegAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getLeftLegPose();
    }

    @Override
    public EulerAngle getRightLegAngle() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).getRightLegPose();
    }

    @Override
    public void setBasePlateVisibility(boolean flag) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setBasePlate(flag);
    }

    @Override
    public boolean hasBasePlateVisibility() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).hasBasePlate();
    }

    @Override
    public boolean hasArmsVisibile() {
        return ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).hasArms();
    }

    @Override
    public void setArmsVisibile(boolean flag) {
        ((org.bukkit.entity.ArmorStand)this.getBukkitEntity()).setArms(flag);
    }

    public ItemStack getItems(EquipmentSlot enumitemslot) {
        return CraftItemStack.asBukkitCopy(super.getItemBySlot(enumitemslot));
    }

    public void setSlot(EquipmentSlot enumitemslot, ItemStack itemstack) {
        VersionHelper.setItemSlot(this, enumitemslot, CraftItemStack.asNMSCopy(itemstack), false);
    }
