...
public class EntityChickenPet extends EntityAgeablePet implements IEntityChickenPet {
    ...
    public void applyCompound(StorageTagCompound object) {
        if (object.hasKey(PetDataRegistry.Chicken.VARIANT.namespace())) setVariant(object.getEnum(PetDataRegistry.Chicken.VARIANT.namespace(), TemperatureVariant.class, TemperatureVariant.TEMPERATE));
