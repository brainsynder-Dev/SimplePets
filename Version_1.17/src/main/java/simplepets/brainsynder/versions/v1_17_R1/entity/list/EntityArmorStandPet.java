...
import simplepets.brainsynder.managers.AnimationCycle;
import simplepets.brainsynder.managers.AnimationManager;
...
public class EntityArmorStandPet extends ArmorStand implements IEntityArmorStandPet {
    ...
    public void tick() {
        ...
        if (walking == null) walking = new AnimationCycle(AnimationManager.WALKING_ANIMATION);
