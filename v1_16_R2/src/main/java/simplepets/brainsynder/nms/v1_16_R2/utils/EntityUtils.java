package simplepets.brainsynder.nms.v1_16_R2.utils;
...
public class EntityUtils {
    ...
    public static net.minecraft.server.v1_16_R2.VillagerProfession getProfession(simplepets.brainsynder.wrapper.villager.VillagerType type) {

        net.minecraft.server.v1_16_R2.VillagerProfession profession = VillagerProfession.NONE;
        switch (type) {
            case ARMORER:
