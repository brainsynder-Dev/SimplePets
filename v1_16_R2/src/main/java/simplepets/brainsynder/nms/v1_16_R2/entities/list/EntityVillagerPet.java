...
/**
 * NMS: {@link net.minecraft.server.v1_16_R2.EntityVillager}
 */
...
public class EntityVillagerPet extends AgeableEntityPet implements IEntityVillagerPet {
    ...
    private static final DataWatcherObject<net.minecraft.server.v1_16_R2.VillagerData> VILLAGER_DATA;
    ...
    protected void registerDatawatchers() {
        ...
        this.datawatcher.register(VILLAGER_DATA, new net.minecraft.server.v1_16_R2.VillagerData(EntityUtils.getTypeFromBiome(BiomeType.PLAINS), VillagerProfession.NONE, 1));
    }
    ...
    private net.minecraft.server.v1_16_R2.VillagerData getRawData() {
        return datawatcher.get(VILLAGER_DATA);
    }

    @Override
    public VillagerData getVillagerData() {
        net.minecraft.server.v1_16_R2.VillagerData raw = getRawData();
    ...
    public void setVillagerData(VillagerData data) {
        net.minecraft.server.v1_16_R2.VillagerType biome = EntityUtils.getTypeFromBiome(data.getBiome());
        datawatcher.set(VILLAGER_DATA, new net.minecraft.server.v1_16_R2.VillagerData(biome, EntityUtils.getProfession(data.getType()), data.getLevel()));
