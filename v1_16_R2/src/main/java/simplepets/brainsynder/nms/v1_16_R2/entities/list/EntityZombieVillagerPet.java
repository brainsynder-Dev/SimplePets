...
/**
 * NMS: {@link net.minecraft.server.v1_16_R2.EntityZombieVillager}
 */
...
public class EntityZombieVillagerPet extends EntityZombiePet implements IEntityZombieVillagerPet {
    ...
    protected void registerDatawatchers() {
        ...
        datawatcher.register(VILLAGER_DATA, new net.minecraft.server.v1_16_R2.VillagerData(EntityUtils.getTypeFromBiome(BiomeType.PLAINS), VillagerProfession.NONE, 1));
