...
/**
 * NMS: {@link net.minecraft.server.v1_16_R2.EntityRabbit}
 */
...
*/
    ...
    public void mobTick() {
        ...
        if (this.onGround) {
            ...
            EntityRabbitPet.ControllerJumpRabbit controller = (EntityRabbitPet.ControllerJumpRabbit)this.bi;
            if (!controller.c()) {
                ...
                ((ControllerJumpRabbit) bi).a(true);
            }
        }
    ...
    private static class ControllerMoveRabbit extends ControllerMove {
        ...
        public void a() {
            if (this.i.onGround && !this.i.jumping && !((EntityRabbitPet.ControllerJumpRabbit)this.i.bi).c()) {
                this.i.i(0.0);
            } else if (this.b()) {
                this.i.i(this.j);
            }
