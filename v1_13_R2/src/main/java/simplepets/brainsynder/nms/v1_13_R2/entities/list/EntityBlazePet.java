...
/**
 * NMS: {@link net.minecraft.server.v1_13_R2.EntityBlaze}
 */
...
public class EntityBlazePet extends EntityPet implements IEntityBlazePet {
    ...
    public EntityBlazePet(EntityTypes<?> type, World world) {
        super(type, world);
    }

    public EntityBlazePet(EntityTypes<?> type, World world, IPet pet) {
