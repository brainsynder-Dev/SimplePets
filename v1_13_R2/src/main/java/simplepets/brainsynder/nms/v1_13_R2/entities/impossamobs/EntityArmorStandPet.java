...
public class EntityArmorStandPet extends EntityArmorStand implements IEntityArmorStandPet {
    ...
    // CONVERSIONS
    private EulerAngle toBukkit (net.minecraft.server.v1_13_R2.Vector3f vector3f) {
        return new EulerAngle(vector3f.getX(), vector3f.getY(), vector3f.getZ());
    }
    private net.minecraft.server.v1_13_R2.Vector3f toNMS (EulerAngle angle) {
        return new net.minecraft.server.v1_13_R2.Vector3f((float)angle.getX(), (float)angle.getY(), (float)angle.getZ());
    }
    public org.bukkit.inventory.ItemStack getItems(net.minecraft.server.v1_13_R2.EnumItemSlot enumitemslot) {
        return toBukkit(getEquipment(enumitemslot));
    }
    private org.bukkit.inventory.ItemStack toBukkit (net.minecraft.server.v1_13_R2.ItemStack stack) {
        return CraftItemStack.asBukkitCopy(stack);
    }
    private net.minecraft.server.v1_13_R2.ItemStack toNMS (org.bukkit.inventory.ItemStack stack) {
        return CraftItemStack.asNMSCopy(stack);
    }

    public void setSlot(net.minecraft.server.v1_13_R2.EnumItemSlot enumitemslot, org.bukkit.inventory.ItemStack itemstack) {
