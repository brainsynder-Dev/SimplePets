package simplepets.brainsynder.nms.registry.v1_11_R1;
...
public class NMSUtils {
    ...
    static {
        try {
            if ((!PetCore.get().getConfiguration().getBoolean("OldPetRegistering")) && (ENTITY_REGISTRY == null)) {
                ...
                PetCore.get().debug("Setting CustomRegistry as main register.");
            }
        } catch (Exception e) {
            PetCore.get().debug("Utilizing Vanilla registry due to a failure.");
        ...
        final Iterator<BiomeBase> iterator = BiomeBase.j.iterator();
        int index = 0;
        while (iterator.hasNext()) {
            BIOMES[index++] = iterator.next();
        }
    }
     ...
     * @param biomes      - Should your mob be set as a default in each biome? Only one custom entity of this type entity can have this set as 'true'.
     */
    public static void registerEntity(final Type type, final Class<? extends Entity> customClass, boolean biomes) {
        registerEntity(type.getName(), type, customClass, biomes);
    }

    static RegistryMaterials<MinecraftKey, Class<? extends Entity>> getRegistry() {
        if (ENTITY_REGISTRY == null) return EntityTypes.b;
     ...
     * Registers the custom class to be available for use.
     *
     * @param id          - The mob id. BE CAREFUL with this. Your Minecraft client renders the entity based on this, and if used improperly, will cause
     *                    unexpected behavior!
    ...
    public enum Biome {
        ...
        /**
         * A large, open biome made entirely of water going up to y=63, with underwater relief on the sea floor, such as small mountains and plains,
         * usually including gravel. Oceans typically extend under 3,000 blocks in any direction, around 60% of the Overworld's surface is covered in
         * Ocean. Small islands with infrequent vegetation can be found in oceans. Passive mobs are unable to spawn on these islands, but hostiles
         * can. Cavern entrances can be found infrequently at the bottom of the ocean. In the Console versions, they surround the edges of the map.
         */
        OCEAN(0),
        /**
         * A relatively flat and grassy biome with rolling hills and few trees. Gullies, water holes, and NPC villages are common. Cave openings and
         * water or lava springs are easily identifiable due to the flat unobstructed terrain. Passive mobs spawn often in plains biomes; this biome
         * and its variants are also one of the only biomes where horses spawn naturally.
         */
        PLAINS(1),
        /**
         * A barren and relatively inhospitable biome consisting mostly of sand dunes, dead bushes, and cacti. Sandstone is commonly found underneath
         * the sand. The only passive mobs to spawn naturally in deserts are gold rabbits, their coloring well-camouflaged against the sand. Sugar
         * cane can be found if the desert is next to an ocean or river biome. The lack of visual obstruction makes mobs highly visible at night.
         * Desert villages, desert wells and desert temples are found exclusively in this biome. This biome sometimes appear as edge of mesa biome.
         */
        DESERT(2),
        /**
         * A highland biome (with some mountaintops reaching y=130 or even higher) with a few scattered oak and spruce trees. Cliffs, peaks, valleys,
         * waterfalls, overhangs, floating islands, caverns, and many other structures exist, offering outstanding views. This is one of the few
         * biomes where llamas spawn naturally. Snowfall also occurs above certain heights, thus creating "snow caps" on the top of the mountains.
         * Falling is a significant risk, as there are many steep ledges large enough to cause severe fall damage or even death. Extreme hills are the
         * only biomes where emerald ores and silverfish can be found naturally.
         */
        EXTREME_HILLS(3),
        /**
         * A biome with a lot of oak and birch trees, occasional hills, and a fair amount of tall grass. Mushrooms and flowers can occasionally be
         * found here. This is one of the most preferred biomes to start out in, due to the abundance of wood. However, the frequency of trees also
         * makes it dangerous to navigate at night, due to obscured vision. Forest biomes are also one of the smallest biomes.
         */
        FOREST(4),
        /**
        ...
        TAIGA(5),
        /**
         * A biome characterized by a mix of flat, dry areas around sea level and shallow pools of brackish green water with floating lily pads. Clay,
         * sand, and dirt are commonly found at the bottom of these pools. Trees are often covered with dark green vines, and can be found growing out
         * from the water. Witch huts generate exclusively in swamps. Slimes will also spawn naturally at night, most commonly on full moons, making
         * this an especially dangerous biome at night. Temperature varies randomly within the biome, not affected by altitude, causing foliage and
         * grass colors to vary.
         */
        SWAMPLAND(6),
        /**
         * A biome that consists of water blocks that form an elongated, curving shape similar to a real river. Unlike real rivers, however, they have
         * no current. Rivers cut through terrain or separate the main biomes. They attempt to join up with ocean on the other side, but will
         * sometimes loop around to the same area of ocean. Rarely, they can have no connection to the ocean and form a circle. They have a dull green
         * grass hue, much like the ocean, and trace amounts of oak trees tend to generate there as well. Rivers are also a reliable source of clay.
         * These biomes are good for fishing.
         */
        RIVER(7),
        /**
         * This is the biome used to generate the Nether. In a Superflat world using this biome, the Overworld will contain only Nether mobs (ghasts,
         * packs of zombie pigmen and occasional magma cubes) and won't receive rain, but it won't have Nether structures (such as Nether quartz or
         * glowstone veins or Nether fortresses), and it can still have water lakes and mineshafts, beds will also explode in this biome, even when in
         * the Overworld.
         */
        HELL(8),
        /**
         * This biome is used to generate the End. The ender dragon, and large amounts of endermen, spawn in this biome. Most of the End's structure
         * is provided by the dimension itself rather than the biome. It does not rain or snow in this biome unlike the other low temperature biomes.
         * The outer islands in the End can be accessed using the End gateway portal after the ender dragon has been defeated. These contain endermen,
         * chorus plants and End cities. End cites are the only place where shulkers naturally spawn .If the biome is used for a superflat world, the
         * sky will be dark gray and an ender dragon will spawn at 0,0 coordinates in the Overworld. Only endermen will spawn at night.
         */
        SKY(9),
        /**
         * A variant of the ocean biome that is completely frozen over. However, warmer rivers occasionally run through it. Doesn't generate in
        ...
        FROZEN_RIVER(11),
        /**
         * A somewhat rare but expansive, flat biome with a huge amount of snow. All sources of water exposed to the sky are frozen over. Sugar cane
         * will generate in this biome, but can become uprooted when chunks load as the water sources freeze to ice. There are very few natural oak
         * and spruce trees in this biome. It has a lower chance of spawning passive mobs during world generation than other biomes (7% versus 10%),
         * however it is one of the few biomes where Polar bears and Strays spawn. Due to the biome's size, snow and ice cover, and scarcity of wood
         * and animals, initial survival becomes difficult in comparison to other biomes.
         */
        ICE_PLAINS(12),
        /**
         * Snowy hills that generate in the {@link #ICE_PLAINS}. Ice Mountains are usually taller, with height comparable to Extreme Hills biomes, and
         * has a lower chance of spawning passive mobs during world generation than other biomes (7% versus 10%).
         */
        ICE_MOUNTAINS(13),
        /**
         * This rare biome consists of a mixture of flat landscape and steep hills and has mycelium instead of grass as its surface. However, if you
         * do place down grass, it is a very bright green color, not unlike that of the jungle. Mushroom islands are most often adjacent to an ocean
         * and are often found isolated from other biomes. It is one of the only biomes where huge mushrooms can generate naturally, and where
         * mushrooms can grow in full sunlight.
         * <p>
         * <p>
         * Technically no mobs other than mooshrooms spawn naturally in this biome, including the usual night-time hostile mobs. This also applies to
         * caves, abandoned mine shafts, and other dark structures, meaning exploring underground is supposedly safe. However, mob spawners will still
         * spawn mobs, and the player will also still be able to breed animals and spawn mobs using eggs.
         */
        MUSHROOM_ISLAND(14),
        /**
        ...
        /**
         * Generated on the shores of oceans, beaches are composed of sand. Beaches penetrate the landscape, removing the original blocks and placing
         * in sand blocks. Some beaches generate with gravel instead of sand. These are also useful for fishing.
         */
        BEACHES(16),
        /**
        ...
        TAIGA_HILLS(19),
        /**
         * Similar to the jungle edge sub-biome, this sub-biome generates exclusively at the edge of extreme hills biomes (or any variant). Doesn't
         * generate in default worlds, but can be accessed using the Customized world type.
         */
         ...
         * the surface of caves. Ocelots, jungle temples, melons, and cocoa plants can be found exclusively in this biome. Melons generate in small
        ...
        JUNGLE_HILLS(22),
        /**
         * A very rare biome that only generates at the border of a jungle biome and any other biome. Similar to a jungle but with much fewer and
         * smaller trees, and relatively flat terrain.
         */
        JUNGLE_EDGE(23),
        /**
         * A variation of the Ocean biome. In deep ocean biomes, the ocean can exceed 30 blocks in depth, making it twice as deep as the normal ocean.
         * In contrast to default oceans, the ground is mainly covered with gravel. Ocean monuments generate in deep oceans, which spawn guardians.
         */
        DEEP_OCEAN(24),
        /**
         * This stone-covered biome often appears adjacent to mountains and the ocean. Depending on the height of the nearby land, it can generate
         * medium slopes or huge cliffs.
         */
        STONE_BEACH(25),
        /**
        ...
        /**
         * This biome is composed of dark oak trees, a mostly closed roof of leaves, and occasional large mushrooms. Trees in this forest are so
         * plentiful and so close together, that at some spots it may become dark enough for hostile mobs to spawn, even during the day. Rarely, a
         * woodland mansion may spawn
         */
        ROOFED_FOREST(29),
        /**
         * A snowy variation of the taiga biome, where ferns(and large ferns) and spruce trees grow. It is one of the few places where wolves will
         * naturally spawn.
         */
        COLD_TAIGA(30),
        /**
        ...
        MEGA_TAIGA_HILLS(33),
        /**
         * A variant of the regular extreme hills biome, adding larger mountains, steeper cliffs, and a moderate amount of spruce trees and scattered
         * oak trees.
         */
        EXTREME_HILLS_WITH_TREES(34),
        /**
         * A relatively flat and dry biome with a dry grass color and scattered acacia trees. Villages can generate in this biome, and it is the only
         * biome where both horses and llamas spawn naturally.
         */
        SAVANNA(35),
        /**
         * Variation of the {@link #SAVANNA} biome. Like the hills biomes, but flattened at the top, coming to rest at about 20 to 30 blocks above sea
         * level.
         */
        SAVANNA_PLATEAU(36),
        /**
         * A rare biome consisting of hardened clay, stained clay, and dead bushes – similar to a desert. Red sand will also generate here instead of
         * regular sand, with occasional cacti. Its composition is useful when other sources of clay are scarce. However, finding mesa biomes can be
         * difficult due to their rarity. On the other hand, it offers great variety - there are a total of 6 variations of this biome to explore.
         * <p>
         * <p>
         * Mesas can contain above ground abandoned mineshafts. They also allow gold ore to generate near surface levels, rather than just at layer 32
         * and below.
         */
        MESA(37),
        /**
        ...
        MESA_PLATEAU_F(38),
        /**
         * Variation of the {@link #MESA} bioime. Like the hills biomes, but flattened at the top, coming to rest at about 20 to 30 blocks above sea
         * level. Only generates in savanna and mesa biomes.
         */
        MESA_PLATEAU(39),
        /**
        ...
        DESERT_M(130),
        /**
         * Variant of the regular extreme hills biome that features higher mountain peaks, most of which reach into the clouds. Mountains here are
         * composed mainly of gravel and a little bit of dirt and grass, with a sparse population of spruce and oak trees.
         */
        EXTREME_HILLS_M(131),
        /**
         * A variant of the forest biome that has fewer trees but has a huge amount of various flowers. There are certain flowers that are exclusive
        ...
        TAIGA_M(133),
        /**
         * A slightly hillier swampland with greener grass. Witch huts do not generate in this biome, unlike the normal swampland biome.
         */
        SWAMPLAND_M(134),
        /**
         * A rare variation of the Ice Plains biome that features large spikes of packed ice, as well as packed ice 'lakes'. Usually the spikes are 10
         * to 20 blocks tall, but some long, thin spikes can reach over 50 blocks in height. All grass blocks in this biome are replaced with blocks
         * of snow. It has a lower chance of spawning passive mobs during world generation than other biomes (7% versus 10%).
         */
        ICE_SPIKES(140),
        /**
         * Much more mountainous version of the normal jungle, with foliage so thick that the ground is barely visible. A very resource-demanding
         * biome. Due to the hilly nature of the terrain in this biome, and the height of the tall jungle trees, trees frequently reach into and go
         * above the clouds. Extremely dense foliage and treacherous hilly terrain make this a very difficult biome to navigate, especially at night.
         */
        JUNGLE_M(149),
        /**
         * The rarest biome in Minecraft. A slightly more mountainous variation of the jungle edge biome, which only generates on the border of a
         * jungle M and another biome. There are very few to no tall trees in this relatively tiny biome.
         */
        JUNGLE_EDGE_M(151),
        /**
        ...
        COLD_TAIGA_M(158),
        /**
         * A variation of the mega taiga. In this biome there is a much higher density of smaller spruce trees. Also, the tall trees look very similar
         * to regular spruce trees, as opposed to the short-topped trees in the normal mega taiga biome.
         */
        ...
        /**
         * Variant of the savanna biome. Dirt paths and giant mountains are prevalent in this biome. However, this biome is unique in that its
         * mountains can generate past the clouds, and even to the world height limit, without using the AMPLIFIED world type.
         */
        SAVANNA_M(163),
        /**
        ...
        /**
         * Mesa (Bryce) is a variant of the mesa biome, featuring a low desert-like ground area with tall, thin, spire-shaped columns of hardened
         * clay, similar to the structures in the real Bryce Canyon.
         */
        MESA_BRYCE(165),
        /**
         * Very rare variant of the Mesa Plateau F biome. Features steeper cliffs than the normal Mesa Plateau F biome, with a reduced occurrence of
         * trees and smaller, more erratic hills.
         */
        MESA_PLATEAU_F_M(166),
        /**
         * The mesa plateau M biome features slightly flatter terrain and smaller plateaus in general, compared to the average mesa plateau biome.
         */
        MESA_PLATEAU_M(167),
        /**
        ...
        /**
         * A Collection of all forest biomes - excluding swamplands, jungles and extreme hills with trees. 16 biomes in total.
         */
        ...
        /**
         * A Collection of all 3 plains; consisting of {@link #PLAINS}, {@link #SUNFLOWER_PLAINS} and {@link #ICE_PLAINS}.
         */
        COLLECTION_PLAINS(1, 12, 129),
        /**
         * A Collection consisting of all 5 icy biomes; {@link #ICE_MOUNTAINS}, {@link #ICE_PLAINS}, {@link #ICE_SPIKES}, {@link #FROZEN_OCEAN} and
         * {@link #FROZEN_RIVER}.
         */
        ...
        /**
         * A Collection consisting of all 5 jungle biomes; {@link #JUNGLE}, {@link #JUNGLE_M}, {@link #JUNGLE_HILLS}, {@link #JUNGLE_EDGE} and
         * {@link #JUNGLE_EDGE_M}.
         */
        COLLECTION_JUNGLE(21, 22, 23, 149, 151),
        /**
         * A Collection consisting of all 4 extreme hills biomes; {@link #EXTREME_HILLS_EDGE}, {@link #EXTREME_HILLS_M}, {@link #EXTREME_HILLS_PLUS_M}
         * , {@link #EXTREME_HILLS_WITH_TREES} and {@link #EXTREME_HILLS}.
         */
        ...
        /**
         * A Collection consisting of all x savanna variants; {@link #SAVANNA_M}, {@link #SAVANNA_PLATEAU_M}, {@link #SAVANNA_PLATEAU} and
         * {@link #SAVANNA}.
         */
    ...
    public enum Type {
        ...
        Type(final int id, final String name, Class<? extends Entity> nmsClazz, final MobMeta meta,
    ...
    public static class SpawnData extends BiomeMeta {
        ...
        /**
         * Creates a new instance of SpawnData, and at the same time, a new instanceof BiomeMeta, used to add random spawns and such.
         *
