...
public class EntitySheepPet extends AgeableEntityPet implements IEntitySheepPet {
    ...
    static {
        COLOR_SHEARED = DataWatcher.a(simplepets.brainsynder.nms.entities.v1_9_R1.list.EntitySheepPet.class, DataWatcherRegistry.a);
    }

    public EntitySheepPet(net.minecraft.server.v1_9_R1.World world, IPet pet) {
        super(world, pet);
    }
