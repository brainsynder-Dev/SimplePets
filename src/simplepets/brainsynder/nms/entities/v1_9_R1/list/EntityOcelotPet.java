...
import simplepets.brainsynder.nms.entities.v1_9_R1.EntityTameablePet;
...
public class EntityOcelotPet extends EntityTameablePet implements IEntityOcelotPet {
    ...
    static {
        TYPE = DataWatcher.a(simplepets.brainsynder.nms.entities.v1_9_R1.list.EntityOcelotPet.class, DataWatcherRegistry.b);
    }


    public EntityOcelotPet(net.minecraft.server.v1_9_R1.World world, IPet pet) {
        super(world, pet);
    }
