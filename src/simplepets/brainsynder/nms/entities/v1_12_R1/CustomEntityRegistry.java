...
public class CustomEntityRegistry extends RegistryMaterials {
    ...
    CustomEntityRegistry(RegistryMaterials<MinecraftKey, Class<? extends Entity>> original) {
    ...
    public void unRegister(int entityId, MinecraftKey key, Class<? extends Entity> entityClass, Class<? extends Entity> replaceentityClass) {
        entityIds.remove(entityClass);
        put(entityId, key, replaceentityClass);
    }
}