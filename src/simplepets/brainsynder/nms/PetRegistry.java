...
public class PetRegistry {
    ...
    public static void unregisterEntity(Class<?> customClass) {
    ...
    public void a(Class paramClass, String paramString, int paramInt) {
        Map<String, Class> mapC = getMap(getField("c", ReflectionUtil.getNmsClass("EntityTypes"), null));
        Map<Class, String> mapD = getMap(getField("d", ReflectionUtil.getNmsClass("EntityTypes"), null));
        Map<Integer, Class> mapE = getMap(getField("e", ReflectionUtil.getNmsClass("EntityTypes"), null));
        Map<Class, Integer> mapF = getMap(getField("f", ReflectionUtil.getNmsClass("EntityTypes"), null));
        Map<String, Integer> mapG = getMap(getField("g", ReflectionUtil.getNmsClass("EntityTypes"), null));
    ...
    public <T> T getField(String fieldName, Class fieldClass, Object instance) {
        try {
            Field tr = fieldClass.getDeclaredField(fieldName);
            tr.setAccessible(true);
            return (T) tr.get(instance);
    ...
    public enum List {
        ...
        //ENDER_DRAGON(111, EntityWrapper.ENDER_DRAGON, "EntityEnderDragonPet", "EntityEnderDragon");
        //CONTROLLER(111, EntityWrapper.ZOMBIE, "EntityControllerPet", "EntityZombie"),
        //SHULKER(111, EntityWrapper.SHULKER, "EntityShulkerPet", "EntityShulker");
        ...
        List(int id, EntityWrapper entityWrapper, String petnmsName, String nmsName) {
            ...
            if (supported) {
                ...
                if (customClass != null) {
                    EntityWrapper type = entityWrapper;
