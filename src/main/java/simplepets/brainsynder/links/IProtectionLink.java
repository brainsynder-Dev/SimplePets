...
public interface IProtectionLink<T extends Plugin> extends IPluginLink<T> {
    ...
    default boolean allowPetRiding(PetOwner owner, Location at) { return allowPetSpawn(at); }
    ...
    default boolean allowPetRiding(Location at) { return allowPetRiding(null, at); }
}