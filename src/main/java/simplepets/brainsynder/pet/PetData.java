...
public enum PetData {
    ...
    SHULKER(Rainbow.class, ShulkerColor.class, ShulkerClosed.class),
    ...
    SHEEP(Rainbow.class, Color.class, Age.class, Shear.class),
    PARROT(Rainbow.class, ParrotColor.class, Sitting.class),
    WIZARD(Spell.class),
    JOHNNY(Johnny.class),
