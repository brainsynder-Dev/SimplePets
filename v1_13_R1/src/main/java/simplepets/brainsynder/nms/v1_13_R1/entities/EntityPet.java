...
import simplepets.brainsynder.nms.v1_13_R1.entities.impossamobs.EntityArmorStandPet;
import simplepets.brainsynder.nms.v1_13_R1.entities.impossamobs.EntityShulkerPet;
...
public abstract class EntityPet extends EntityCreature implements IAnimal,
    ...
    public EntityPet(EntityTypes<?> type, World world, IPet pet) {
        super(type, world);
        this.pet = pet;
        this.collides = false;
    ...
    public EntityPet(EntityTypes<?> type, World world) {
        super(type, world);
        ...
        if (passengers == null) {
            ...
            if (!world.isClientSide) {
                ...
                if (this instanceof IEntityHorsePet) {
                    ...
                    this.aI = this.aJ; // this.prevLimbSwingAmount = this.limbSwingAmount;
                    ...
                    this.aJ += (f5 - this.aJ) * 0.4; // this.limbSwingAmount += (f5 - this.limbSwingAmount) * 0.4F;
                    this.aK += this.aJ; // this.limbSwing += this.limbSwingAmount;
                }
            }
