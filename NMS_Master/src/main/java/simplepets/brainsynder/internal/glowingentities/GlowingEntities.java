package simplepets.brainsynder.internal.glowingentities;
...
public class GlowingEntities implements Listener {
	...
	private static class Packets {
		...
		private static final Cache<Object, Object> packets = CacheBuilder.newBuilder().expireAfterWrite(5, TimeUnit.SECONDS).build();
		...
		private enum ProtocolMappings {
			...
			ProtocolMappings(int major, String watcherFlags, String markerTypeId, String watcherAccessor, String playerConnection, String networkManager, String sendPacket, String channel, String teamSetCollsion, String teamSetColor) {
				this.major = major;
