...
public class AnimationManager {
    ...
    public static final MovementFrames walk = new MovementFrames(
            ...
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.05D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.05D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.1D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.1D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.15D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.15D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.2D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.2D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.25D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.25D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.3D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.3D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.35D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.35D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.4D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.4D, 0.0D, 0.0D)),
            (new AnimationFrame())
                    .setLeftLeg(new EulerAngle(0.45D, 0.0D, 0.0D))
                    .setRightLeg(new EulerAngle(-0.45D, 0.0D, 0.0D)),
            (new AnimationFrame())
