...
public class EntityCatPet extends EntityTameablePet implements IEntityCatPet {
    private static final EntityDataAccessor<Integer> TYPE; // This is no longer an int, it is a CatVariant
    ...
    static {
        TYPE = SynchedEntityData.defineId(EntityCatPet.class, EntityDataSerializers.INT); // As per 1.19    INT -> CAT_VARIANT
