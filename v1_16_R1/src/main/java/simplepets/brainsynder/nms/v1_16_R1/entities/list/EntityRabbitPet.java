...
/**
 * NMS: {@link net.minecraft.server.v1_16_R1.EntityRabbit}
 */
...
public class EntityRabbitPet extends AgeableEntityPet implements IEntityRabbitPet {
    ...
    public EntityRabbitPet(EntityTypes<? extends EntityCreature> type, World world, IPet pet) {
        ...
        bp = new ControllerJumpRabbit(this);
...
*/
    ...
    public void mobTick() {
        ...
        if (this.onGround) {
            ...
            EntityRabbitPet.ControllerJumpRabbit controller = (EntityRabbitPet.ControllerJumpRabbit)this.bp;
            if (!controller.c()) {
                ...
                ((ControllerJumpRabbit) bp).a(true);
            }
        }
    ...
    private static class ControllerMoveRabbit extends ControllerMove {
        ...
        public void a() {
            if (this.i.onGround && !this.i.jumping && !((EntityRabbitPet.ControllerJumpRabbit)this.i.bp).c()) {
                this.i.i(0.0);
            } else if (this.b()) {
                this.i.i(this.j);
            }
