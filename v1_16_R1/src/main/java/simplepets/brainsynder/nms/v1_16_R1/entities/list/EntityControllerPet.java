...
public class EntityControllerPet extends EntityZombiePet implements IEntityControllerPet {
    ...
    public void repeatTask() {
        ...
        if (this.displayEntity != null) {
            if (this.displayEntity.isValid()) {
                net.minecraft.server.v1_16_R1.Entity entity = ((CraftEntity) displayEntity).getHandle();
    ...
    public void updateName(net.minecraft.server.v1_16_R1.Entity entity) {
        if (hasCustomName()) {
    ...
    public void reloadLocation() {
        if (displayEntity.getPassenger() != null) {
            net.minecraft.server.v1_16_R1.Entity displayEntity = ((CraftEntity) this.displayEntity).getHandle();
            Location loc;
    ...
    public void move(Vec3D vec3D, FieldAccessor<Boolean> fieldAccessor) {
        ...
        if (!world.isClientSide) {
            super.f(new Vec3D(strafe, vertical, forward));
        }
