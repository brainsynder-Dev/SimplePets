...
public class EntityVillagerPet extends AgeableEntityPet implements IEntityVillagerPet {
    ...
    protected void registerDatawatchers() {
        ...
        this.datawatcher.register(VILLAGER_DATA, new net.minecraft.server.v1_14_R1.VillagerData(EntityUtils.getTypeFromBiome(BiomeType.PLAINS), VillagerProfession.NONE, 1));
    }
    ...
    public VillagerData getVillagerData() {
        net.minecraft.server.v1_14_R1.VillagerData raw = getRawData();
