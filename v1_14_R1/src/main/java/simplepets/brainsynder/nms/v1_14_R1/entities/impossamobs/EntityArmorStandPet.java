...
public class EntityArmorStandPet extends EntityArmorStand implements IEntityArmorStandPet {
    ...
    // CONVERSIONS
    private EulerAngle toBukkit (net.minecraft.server.v1_14_R1.Vector3f vector3f) {
        return new EulerAngle(vector3f.getX(), vector3f.getY(), vector3f.getZ());
    }
    private net.minecraft.server.v1_14_R1.Vector3f toNMS (EulerAngle angle) {
        return new net.minecraft.server.v1_14_R1.Vector3f((float)angle.getX(), (float)angle.getY(), (float)angle.getZ());
    }
    public ItemStack getItems(net.minecraft.server.v1_14_R1.EnumItemSlot enumitemslot) {
        return toBukkit(getEquipment(enumitemslot));
    }
    private ItemStack toBukkit (net.minecraft.server.v1_14_R1.ItemStack stack) {
        return CraftItemStack.asBukkitCopy(stack);
    }
    private net.minecraft.server.v1_14_R1.ItemStack toNMS (ItemStack stack) {
        return CraftItemStack.asNMSCopy(stack);
    }

    public void setSlot(net.minecraft.server.v1_14_R1.EnumItemSlot enumitemslot, ItemStack itemstack) {
