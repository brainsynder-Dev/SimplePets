...
<dependency>
    ...
    <version>R5-B315</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'org.bsdevelopment.simplepets:api:R5-B315' // This version is automatically updated
}
```
