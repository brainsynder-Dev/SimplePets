...
<dependency>
    ...
    <version>R5-B309</version>  <!-- This version is automatically updated -->
</dependency>
```
...
dependencies {
    implementation 'org.bsdevelopment.simplepets:api:R5-B309' // This version is automatically updated
}
```
