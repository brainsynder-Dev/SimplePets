...
public class Color extends MenuItemAbstract {
    ...
    public List<ItemBuilder> getDefaultItems() {
        ...
        for (DyeColorWrapper color : DyeColorWrapper.values()) {
            ItemBuilder item = lib.brainsynder.nms.DataConverter.getColoredMaterial(lib.brainsynder.nms.DataConverter.MaterialType.WOOL, lib.brainsynder.utils.DyeColorWrapper.getByName(color.name()));
            item.withName(" ");
